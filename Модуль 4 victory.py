...
# Джон Кристофер Депп: 09.06.1963
# Хью Джекман: 12.10.1968
# Джордж Лукас: 14.05.1944
# Моника Беллуччи: 30.09.1964
# Арнольд Шварценеггер: 30.07.1947
# Эмма Стоун: 06.11.1988
# Энн Хэтэуэй: 12.11.1982
# Дженнифер Энистон: 11.02.1969
# Леонардо Ди Каприо: 11.11.1974
# Уилл Смит: 25.09.1968
...
def victory(): # Записываем функция и в ней формируем викторину
    ...
    b_n = [Famose('09.06.1963', 'Джон Кристофер Депп'), Famose('12.10.1968', 'Хью Джекман'),
           ...
           Famose('06.11.1988', 'Эмма Стоун'), Famose('12.11.1982', 'Энн Хэтэуэй'), Famose('11.02.1969', 'Дженнифер Энистон'),
    ...
    for i in range(
        ...
        if c[i].birthday == input('Введите ответ в формате (dd.mm.yyyy): '):
            ...
            counter_wrong += 1
            print('Правильный ответ: ', f'{day_month[int(c[i].birthday.split(".")[0]) - 1]} {month_year[int(c[i].birthday.split(".")[1]) - 1]} {c[i].birthday.split(".")[2]} года')  # Переводим день и месяц в буквенный вид
